...
$(function () {
    ...
    (function (con) {
        ...
        con.ResetQuestion = function(){
          ...
          $(".ans-letter svg text").attr("fill", "#ecac17");
        ...
        con.ResetAnswerFC = function(answer = "") {
          if (answer == "") {
            ...
            $("#answer-" + answer + " .ans-letter svg text").attr("fill", "#ecac17");
        ...
        con.TextUpdateData(".ans-letter", "A:", 1);
        con.TextUpdateData(".ans-letter", "B:", 2);
        con.TextUpdateData(".ans-letter", "C:", 3);
        con.TextUpdateData(".ans-letter", "D:", 4);
        ...
        onValue(ref(db, dbKey), (snapshot) => {
            ...
            con.TextUpdateData(".cont-name", eval("data.cont_name_" + data.cont_to_introduce), 1);
            con.TextUpdateData(".cont-hometown", eval("data.cont_hometown_" + data.cont_to_introduce), 1);
          
            con.TextUpdateData(".question", data.question_line_1, 1);
            con.TextUpdateData(".question", data.question_line_2, 2);
            con.TextUpdateData(".ans-text", data.answer_a, 1);
            con.TextUpdateData(".ans-text", data.answer_b, 2);
            con.TextUpdateData(".ans-text", data.answer_c, 3);
            con.TextUpdateData(".ans-text", data.answer_d, 4);
            ...
            con.TextUpdateData(".fa-ans-letter", data.correct_order_1.toUpperCase() + ":", 1);
            con.TextUpdateData(".fa-ans-letter", data.correct_order_2.toUpperCase() + ":", 2);
            con.TextUpdateData(".fa-ans-letter", data.correct_order_3.toUpperCase() + ":", 3);
            con.TextUpdateData(".fa-ans-letter", data.correct_order_4.toUpperCase() + ":", 4);
            con.TextUpdateData(".fa-ans-text", eval("data.answer_" + data.correct_order_1), 1);
            con.TextUpdateData(".fa-ans-text", eval("data.answer_" + data.correct_order_2), 2);
            con.TextUpdateData(".fa-ans-text", eval("data.answer_" + data.correct_order_3), 3);
            con.TextUpdateData(".fa-ans-text", eval("data.answer_" + data.correct_order_4), 4);
