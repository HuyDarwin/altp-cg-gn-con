    ...
    (function (con) {
        ...
        onValue(ref(db, dbKey), (snapshot) => {
            ...
            if (data.showing_fff_order == true) {
              con.TextUpdateData(".fff-q-gpx .ans-letter", data.correct_order_1.toUpperCase() + ":", 1);
              con.TextUpdateData(".fff-q-gpx .ans-letter", data.correct_order_2.toUpperCase() + ":", 2);
              con.TextUpdateData(".fff-q-gpx .ans-letter", data.correct_order_3.toUpperCase() + ":", 3);
              con.TextUpdateData(".fff-q-gpx .ans-letter", data.correct_order_4.toUpperCase() + ":", 4);
              con.TextUpdateData(".fff-q-gpx .ans-text", eval("data.answer_" + data.correct_order_1), 1);
              con.TextUpdateData(".fff-q-gpx .ans-text", eval("data.answer_" + data.correct_order_2), 2);
              con.TextUpdateData(".fff-q-gpx .ans-text", eval("data.answer_" + data.correct_order_3), 3);
              con.TextUpdateData(".fff-q-gpx .ans-text", eval("data.answer_" + data.correct_order_4), 4);
            }
            else {
              con.TextUpdateData(".fff-q-gpx .ans-letter", "A:", 1);
              con.TextUpdateData(".fff-q-gpx .ans-letter", "B:", 2);
              con.TextUpdateData(".fff-q-gpx .ans-letter", "C:", 3);
              con.TextUpdateData(".fff-q-gpx .ans-letter", "D:", 4);
              con.TextUpdateData(".fff-q-gpx .ans-text", data.answer_a, 1);
              con.TextUpdateData(".fff-q-gpx .ans-text", data.answer_b, 2);
              con.TextUpdateData(".fff-q-gpx .ans-text", data.answer_c, 3);
              con.TextUpdateData(".fff-q-gpx .ans-text", data.answer_d, 4);
            }
            ...
            con.TextUpdateData(".main-q-gpx .ans-letter", "A:", 1);
            con.TextUpdateData(".main-q-gpx .ans-letter", "B:", 2);
            con.TextUpdateData(".main-q-gpx .ans-letter", "C:", 3);
            con.TextUpdateData(".main-q-gpx .ans-letter", "D:", 4);
            con.TextUpdateData(".main-q-gpx .ans-text", data.answer_a, 1);
            con.TextUpdateData(".main-q-gpx .ans-text", data.answer_b, 2);
            con.TextUpdateData(".main-q-gpx .ans-text", data.answer_c, 3);
            con.TextUpdateData(".main-q-gpx .ans-text", data.answer_d, 4);
            ...
            con.TextUpdateData(".mt-cont-name", eval("data.cont_name_" + data.cont_now), 1);
            con.TextUpdateData(".mt-q-left", "Còn lại " + (data.q_top - data.q_now + 1) + " câu hỏi");
            con.TextUpdateData(".mt-c-left", "Còn lại " + data.c_left + " người chơi");
